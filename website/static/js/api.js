...
const stringifyMethodSection = () => {
    ...
    const analysis = (report.design.analysis === 0) ? "<u>Coffee will determine the statistical tests for you after filling out the form</u>" : report.design.analysis;
    ...
    if(hypothesis_from_tea.length === 0) hypothesisText += "<u>Please specify any hypothesis in Coffee</u>"
