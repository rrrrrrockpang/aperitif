...
// The GET Request might be slow
API_URL = "https://aperitif-prototype.herokuapp.com/getMethod"
API_SAMPLE_URL = 'https://aperitif-prototype.herokuapp.com/getSamples'
...
const commitData = (owner, name) => {
    ...
    console.log(record);
    sleep(5000);
    createRecord("https://aperitif-prototype.herokuapp.com/push", record);
}
